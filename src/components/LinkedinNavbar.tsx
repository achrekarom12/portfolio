        ...
        <header className="fixed top-0 left-0 w-full bg-white border-b border-[#e0dfdc] z-50 h-[56px]">
            <div className="container-max h-full flex items-center justify-between px-4 sm:px-0 relative">
                <div className="flex items-center gap-2 flex-1 md:flex-none">
                    ...
                    {/* Mobile Search Icon */}
                    <div className="md:hidden ml-2 flex items-center h-full text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" width="24" height="24" focusable="true" className="fill-gray-600">
                ...
                <nav className="flex items-center h-full space-x-0 md:space-x-1 pt-0 md:pt-2">
                    <Link href="/" className="flex flex-col items-center justify-center min-w-[48px] md:min-w-[80px] h-[52px] md:border-b-2 border-black text-black">
                        <div className="relative">
                            ...
                            <span className="absolute -top-1 -right-1 bg-[#cc1016] border-2 border-white rounded-full h-3 w-3"></span>
                        </div>
                        <span className="text-[12px] mt-0.5 hidden md:block">Home</span>
                    </Link>

                    <Link href="#" className="flex flex-col items-center justify-center min-w-[48px] md:min-w-[80px] h-[52px] text-gray-500 hover:text-black">
                    ...
                    <Link href="#" className="flex flex-col items-center justify-center min-w-[48px] md:min-w-[80px] h-[52px] text-gray-500 hover:text-black">
                        <div className="relative">
                            ...
                            <span className="absolute -top-1 -right-1 bg-[#cc1016] text-white text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center border-2 border-white">1</span>
                        </div>
                        <span className="text-[12px] mt-0.5 hidden md:block">Notifications</span>
                    </Link>

                    <div className="hidden md:flex flex-col items-center justify-center cursor-pointer min-w-[80px] h-[52px] border-b-2 border-transparent text-gray-500 hover:text-black hover:fill-black ml-1 border-l border-gray-100 pl-2">
