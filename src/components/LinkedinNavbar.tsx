        ...
        <header className="fixed top-0 left-0 w-full bg-[var(--nav-bg)] border-b border-[var(--nav-border)] z-50 h-[56px] transition-colors duration-200">
            <div className="container-max h-full flex items-center justify-between px-4 sm:px-0 relative">
                ...
                <nav className="flex items-center h-full space-x-0 md:space-x-1 pt-0 md:pt-2">
                    <Link href="/" className="flex flex-col items-center justify-center min-w-[48px] md:min-w-[80px] h-[52px] md:border-b-2 border-[var(--text-main)] text-[var(--text-main)] transition-colors">
                        <div className="relative">
                    ...
                    <Link href="#" className="flex flex-col items-center justify-center min-w-[48px] md:min-w-[80px] h-[52px] text-[var(--text-dim)] hover:text-[var(--text-main)] transition-colors">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <button
                            ...
                            className="hidden md:flex flex-col items-center justify-center cursor-pointer min-w-[80px] h-[52px] border-b-2 border-transparent text-[var(--text-dim)] hover:text-[var(--text-main)] ml-1 border-l border-[var(--divider)] pl-2 transition-colors duration-200"
                        >
