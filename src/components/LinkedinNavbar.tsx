                        ...
                        {isMeOpen && (
                            <div className="absolute right-0 top-[56px] w-[280px] bg-[var(--card-bg)] border border-[var(--border-main)] rounded-lg shadow-xl overflow-hidden py-2 z-[60] animate-in fade-in slide-in-from-top-2 duration-200">
                                <div className="px-4 py-3 border-b border-[var(--divider)]">
                                    ...
                                    <Link href="/" className="block mt-3 text-center w-full py-1 border border-[var(--accent-color)] text-[var(--accent-color)] font-semibold rounded-full text-sm transition-colors">
                                        View Profile
                                    </Link>
                                </div>
                                ...
                                <div className="py-2">
                                    <div className="px-4 py-2 flex items-center justify-between transition-colors cursor-pointer" onClick={toggleTheme}>
                                        ...
                                        <div className={`w-12 h-6 rounded-full relative transition-colors duration-200 ${theme === 'dark' ? 'bg-[var(--accent-color)]' : 'bg-gray-300'}`}>
