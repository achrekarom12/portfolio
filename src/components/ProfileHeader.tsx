        ...
        <section className="linkedin-card relative pt-[100px] sm:pt-[200px]">
            ...
            <div className="absolute top-0 left-0 w-full h-[150px] sm:h-[200px] overflow-hidden rounded-t-lg">
                ...
                <button className="absolute top-4 right-4 bg-white/60 p-2 rounded-full hover:bg-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" width="24" height="24" focusable="false" className="text-[#0a66c2]"><path d="M21.13 2.86a3 3 0 00-4.17 0l-13 13L2 22l6.19-2 13-13a3 3 0 000-4.17zM6.76 19.5L4.5 20.24l.74-2.25L15.12 8 16 8.88 6.76 19.5zM18.88 11.76l-.88.88-2.64-2.64.88-.88a1 1 0 011.32 0l1.32 1.32a1 1 0 010 1.32z"></path></svg>
                </button>
            </div>
                ...
                <div className="mt-12 sm:mt-8">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <div className="text-sm text-gray-500 mt-1 flex items-center gap-1 flex-wrap">
                                ...
                                <a href="#" className="text-[#0a66c2] hover:underline font-semibold">Contact info</a>
                            </div>
                    ...
                    <div className="mt-6 p-4 bg-[#eef3f8] rounded-lg flex justify-between items-start cursor-pointer hover:bg-[#e6eff6] transition-colors relative">
                        <div>
                            ...
                            <p className="text-sm text-gray-900">Software Engineer, Full Stack Engineer, Frontend Engineer and Backend Engineer roles</p>
